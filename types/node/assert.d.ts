...
declare module "assert" {
    ...
    namespace assert {
        ...
        interface Assert extends Pick<
            typeof assert,
            {
                [K in keyof typeof assert]: typeof assert[K] extends typeof assert ? never
                    : typeof assert[K] extends (...args: any[]) => void ? K
                    : never;
            }[keyof typeof assert]
        > {
            readonly [kOptions]: AssertOptions & { strict: boolean };
        }
        interface AssertStrict extends Pick<
            typeof strict,
            {
                [K in keyof typeof strict]: typeof strict[K] extends typeof strict ? never
                    : typeof strict[K] extends (...args: any[]) => void ? K
                    : never;
            }[keyof typeof strict]
        > {
        ...
        var Assert: {
             ...
             */
            new(
                options: AssertOptions & { strict: false },
            ): Assert;
            new(
