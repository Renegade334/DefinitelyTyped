...
export interface CreateTeamProps {
    /** An array of managing administrator IDs. */
    managers: string[];
    /** A unique name for the team. */
    name: string;
    /** An array of worker IDs. */
    workers: string[];
    /** The ID of the team's hub. */
...
export interface AutoDispatchTeamProps {
    /** Time in Minutes a task can be late. Default value is 10, must be above 0. */
...
declare class Teams {
    autoDispatch(id: string, obj?: AutoDispatchTeamProps): Promise<AutoDispatchTeamResult>;
    create(obj: any): Promise<OnfleetTeam>;
    deleteOne(id: string): Promise<void>;
    get(): Promise<OnfleetTeam[]>;
    get(id: string): Promise<OnfleetTeam>;
    getWorkerEta(id: string, obj?: GetWorkerETAProps): Promise<GetWorkerEtaResult>;
